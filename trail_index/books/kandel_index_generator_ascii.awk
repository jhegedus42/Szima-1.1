...
BEGIN {
  ...
  bridge["MEM"]="Szima-híd: a csatorna szelektív áteresztése az E8xE8 algebrai sűrűség-vektoraiként (bal E8 = tér, jobb E8 = szín) modellezhető; a membránfeszültség a FazisAlgebra "fazis" dimenziója, a mérés pedig a Steane713 [[7,1,3]] kód egy bitje."
  ...
  bridge["DEV"]="Szima-híd: a fejlődési molekuláris kódok a KategoriaElmelet funktoraiként írják le a sejtidentitást (objektum -> típus); az elosztott és moduláris vezérlés az E8xE8 szimmetrikus monoidális kategória szerkezete, robusztusságot adva."
...
END {
  ...
  print "E8xE8 algebra, a kategóriaelmélet, a FazisAlgebra, a Steane713 és az OktonionAlgebra"
  ...
  print "structure (E8xE8 algebra, category theory, phase algebra, Steane [[7,1,3]], octonions)."
  print ""
