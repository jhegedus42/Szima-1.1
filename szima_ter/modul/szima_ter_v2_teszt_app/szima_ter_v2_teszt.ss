...
(define Main_v2-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "============================================\xa;" ext-0))) (let ((act-2 (PreludeC-45IO-prim__putStr "SZIMA-TER v2 -- holografikus kod MANTRA-teszt\xa;" ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr "============================================\xa;" ext-0))) (let ((act-4 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-5 (PreludeC-45IO-prim__putStr "1. A FazaKorrelacioT instance-ok alap-konstansai:\xa;" ext-0))) (let ((act-6 (PreludeC-45IO-prim__putStr (string-append (KomplexByte-u--show_Show_Komplex KomplexByte-komplexZero) "\xa;") ext-0))) (let ((act-7 (PreludeC-45IO-prim__putStr (string-append (KomplexByte-u--show_Show_Komplex KomplexByte-komplexEgy) "\xa;") ext-0))) (let ((act-8 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-9 (PreludeC-45IO-prim__putStr "2. Az ures perem tipusneve (a fordito latja a biteket):\xa;" ext-0))) (let ((act-10 (PreludeC-45IO-prim__putStr "Perem7HetesV2 Nulla Nulla Nulla Nulla Nulla Nulla Nulla\xa;" ext-0))) (let ((act-11 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-12 (PreludeC-45IO-prim__putStr "3. A teljes perem tipusneve:\xa;" ext-0))) (let ((act-13 (PreludeC-45IO-prim__putStr "Perem7HetesV2 Egy Egy Egy Egy Egy Egy Egy\xa;" ext-0))) (let ((act-14 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-15 (PreludeC-45IO-prim__putStr "4. Az ures holografikus kod tipusneve:\xa;" ext-0))) (let ((act-16 (PreludeC-45IO-prim__putStr "HolografikusKod49V2 Nulla Nulla Nulla Nulla Nulla Nulla Nulla\xa;" ext-0))) (let ((act-17 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (let ((act-18 (PreludeC-45IO-prim__putStr "5. A v2 modul forditasi ideju Refl-bizonyitasok:\xa;" ext-0))) (let ((act-19 (PreludeC-45IO-prim__putStr "   bizUresUresEgyenlo, bizUresEgyEgyenlo,\xa;" ext-0))) (let ((act-20 (PreludeC-45IO-prim__putStr "   bizEgyUresEgyenlo, bizEgyEgyEgyenlo,\xa;" ext-0))) (let ((act-21 (PreludeC-45IO-prim__putStr "   bizUressCimkeUres -- mind Refl (a fordito ellenorizte).\xa;" ext-0))) (let ((act-22 (PreludeC-45IO-prim__putStr "\xa;" ext-0))) (PreludeC-45IO-prim__putStr "Kesz.\xa;" ext-0)))))))))))))))))))))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (lambda (eta-0) (Main_v2-main eta-0)))
