...
||| mondat (3), gondolat (4).
public export
data FaSzint = Level | Szotag | Szo | Mondat | Gondolat

||| A fa-szint szamkent: Level=0, Szotag=1, Szo=2, Mondat=3, Gondolat=4.
public export
faSzintErtek : FaSzint -> Nat
faSzintErtek Level    = 0
...
public export
CarnotLepes : Type
CarnotLepes = MagyarCarnotE9_v2_2_CodatAlpha.CarnotLepes
...
faSzintCarnot szint lepes =
  case (szint, lepes) of
    (Level,    IzotermExpanzio)        => IzotermExpanzio
...
javitasSzint Level    = 1     -- 1 bit a levelen (Steane [[7,1,3]])
...
|||   Level: paritás (zönges/zöngétlen, rovid/hosszu) -- 1 szimmetria
...
szimmetriaSzinten Level    = Paritas
...
public export
bizFaOtSzint : faSzintErtek Level + faSzintErtek Szotag +
