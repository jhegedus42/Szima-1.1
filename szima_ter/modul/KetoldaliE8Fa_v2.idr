...
public export
gamma5 : Gamma5
gamma5 = delta  -- = 8.23e-7 a CODATA elteres

||| A γ^5 előjele: pozitív (a buborék fennáll) vagy közel nulla.
public export
gamma5Pozitiv : Bool
gamma5Pozitiv = gamma5 > 0.0
...
|||   Level: 2 bit (1 pozitiv + 1 negativ)
|||   Szotag: 4 bit (2 + 2)
|||   Szo: 8 bit (4 + 4)
|||   Mondat: 16 bit (8 + 8)
...
ketoldaliJavitasSzinten Level    = 2
